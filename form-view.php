        ...
        <fieldset>
            ...
            <?php foreach ($products as $i => $product): ?>
                <label>
                    ...
                    <input type="checkbox" value="1" <?php if(isset($_POST['products'][$i])) { foreach($_POST['products'] as $tmp) { if($tmp == "1") { echo "checked=\"checked\""; break; }}} ?> name="products[<?php echo $i ?>]"/> <?php echo $product['name'] ?> -
